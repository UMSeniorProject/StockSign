...
public class ChartMethods {
   ...
   */
  public static XYMultipleSeriesDataset buildDataset(String[] titles, List<float[]> xValues,
      List<float[]> yValues) {
  ...
  public static void addXYSeries(XYMultipleSeriesDataset dataset, String[] titles, List<float[]> xValues,
   ...
   */
  public static CategorySeries buildCategoryDataset(String title, float[] values) {
   ...
   * @return the category series
   */
  public static MultipleCategorySeries buildMultipleCategoryDataset(String title,
      List<String[]> titles, List<float[]> values) {
   ...
   */
  public static XYMultipleSeriesDataset buildBarDataset(String[] titles, List<float[]> values) {
    XYMultipleSeriesDataset dataset = new XYMultipleSeriesDataset();
    int length = titles.length;
    for (int i = 0; i < length; i++) {
