...
public class TotalScore extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(TotalScore.this,
	...
	private void initialize() {
		...
		hotTextView.setText(KinveyConstants.TOTAL_SCORE_STOCKS_TITLE);
	...
	public void displayData(Intent intent) {
		...
		for (int current = 0; current < tickers.length; current++) {
			...
			TableRow tr = new TableRow(TotalScore.this);
			...
			TextView labelTV = new TextView(TotalScore.this);
			...
			TextView valueTV = new TextView(TotalScore.this);
