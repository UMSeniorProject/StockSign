...
public class SearchStockActivity extends Activity {
	...
	private void initializeListeners() {
		...
		searchTerm.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,
				...
				if (s.toString().length() != 0) {
					...
					// type_elapsed_time =
					// (type_end_time-type_start_time)/1000000;
		...
		searchTerm.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent i = new Intent(SearchStockActivity.this,
	...
	private void displayAutoComplete() {
		...
		/*
		 * if(!adapter.isEmpty()) adapter.clear(); //delete all previously
		 * stored data
		 */
		...
		adapter = new ArrayAdapter<String>(SearchStockActivity.this,
